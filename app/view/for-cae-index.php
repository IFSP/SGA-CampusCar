					...
					<form method="POST" action="">
						<table style="margin:20px">
							<tr>
								...
								<td>Semestre</td>
								<td style="padding:0 0 0 30px;"><input type="submit" value="Buscar" /></td>
							</tr>
						</table>
					</form>
					<br />
					...
					<?php foreach($objetos['professor_for'] as $key => $for) : ?>
						<tr style="font-weight:bold; width:50%">
							...
							<?php if($for->getStatus() == 0) {
									...
									echo '<span class="status-for">Aguardando aprovação da CAE</span><a href="/for/aprovar/id/'.$for->getId().'"> (Aprovar)</a>';
								} else {
